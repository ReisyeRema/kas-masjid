...
<head>
    ...
    <title>Cetak Laporan Kas Sosial Masjid</title>
</head>

<body>
    <div class="container">
        <h2>LAPORAN KAS SOSIAL AL-JIHAD PANGKALAN KERINCI</h2>
        ...
        <table class="static">
            ...
            <tbody>
                @php $no = 1; @endphp
                @foreach ($pemasukanSosial as $pemasukan)
                    <tr>
                        <td>{{ $no++ }}</td>
                ...
                @endforeach
                @foreach ($pengeluaranSosial as $pengeluaran)
                    <tr>
                        <td>{{ $no++ }}</td>
